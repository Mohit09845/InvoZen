    ...
    <Card className="w-full max-w-4xl mx-auto">
      <CardContent className="p-6">
        <form id={form.id} action={action} onSubmit={form.onSubmit} noValidate>
          ...
          {/* This input is for Calendar because Calendar component itself doesn't send it's data to database that's why it is hidden */}
          <input 
            type="hidden" 
          ...
          <div className="flex flex-col gap-1 w-fit mb-6">
            <div className="flex items-center gap-4">
              <Badge variant="secondary" className="bg-gray-300">Draft</Badge>
              <Input 
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <Input
                  ...
                  defaultValue={(firstName || "Your Name") + " " + (lastName || "")}
                />
