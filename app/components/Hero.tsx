  ...
  return (
    <section className="relative flex flex-col items-center justify-center py-12 lg:py-20">
      <div className="text-center">
        <div className="relative inline-block px-4 py-2 rounded-full bg-gray-100 border-[3px] border-transparent animate-border-motion">
          <span className="magic-text bg-gradient-to-r from-yellow-400 via-red-500 to-purple-500 bg-clip-text text-transparent text-lg font-bold">
            Introducing InvoZen
          </span>
        </div>
        ...
        <p className="max-w-xl mx-auto mt-4 lg:text-lg text-muted-foreground">
          Creating Invoices can be a pain! We at InvoZen make it super easy for
