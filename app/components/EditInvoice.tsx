...
// This componenet is exactly same as createInvoice just we used editInvoice extra here.
    ...
    <Card className="w-full max-w-4xl mx-auto">
      <CardContent className="p-6">
        <form id={form.id} action={action} onSubmit={form.onSubmit} noValidate>
          ...
          {/* This input is providing form id which we use in editInvoice action */}
